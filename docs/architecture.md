...
이 시스템은 일부러 웹앱으로 만들지 않았습니다. Codex 대화창을 인터페이스로 쓰고, 레포는 Codex 플러그인 형태로 패키징합니다.
...
과목이 2~3개 이상으로 늘어나면 Python seed 파일을 계속 추가하기보다 JSON/YAML 가져오기 도구로 바꾸는 게 맞습니다. 자세한 설계는 `docs/exam-expansion-plan.md`에 둡니다.
